        ...
        switch (e.demo1.animate({scrollTop: e.demo1.scrollTop() + n}, 0), a) {
                ...
                !function p() {
                    ...
                    9 === ++o && parent.layer.confirm("怎么样，是否很喜欢该皮肤，去下载？", {skin: "layer-ext-moon"}, function (e, t) {
                        t.find(".layui-layer-btn0").attr({
                            href: "../../../layer.layui.com/skin.html",
                            target: "_blank"
            ...
            case 15:
                parent.layer.tab({
                    ...
                    tab: [{
                        title: "无题",
                        content: '<div style="padding:20px; line-height:30px; text-align:center">_25E6_25AC_25A2_25E8_25BF_258E_25E4_25BD_2593_25E9_25AA_258Clayer.tab<br>此时此刻不禁让人吟诗一首：<br>一入前端深似海<br>从此妹纸是浮云<br>以下省略七个字<br>。。。。。。。<br>——贤心</div>'
                ...
                break;
            case 16:
                e.photoJSON ? layer.photos({photos: e.photoJSON}) : $.getJSON("js/demo/photos.json", function (t) {
