...
// */
// @Configuration
// @MapperScan(basePackages = "cn.elwy.eplus.core", sqlSessionTemplateRef =
/// "customTestSqlSessionTemplate")
...
/// customTestSqlSessionFactory(@Qualifier("customTestDataSource") DataSource
/// customTestDataSource) throws Exception {
...
/// customTestTransactionManager(@Qualifier("customTestDataSource") DataSource
...
/// testSqlSessionTemplate(@Qualifier("customTestSqlSessionFactory")
