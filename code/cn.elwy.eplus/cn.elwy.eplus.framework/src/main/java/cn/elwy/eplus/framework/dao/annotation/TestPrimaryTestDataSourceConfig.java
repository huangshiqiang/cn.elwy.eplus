...
// * @Author :yadong.zhang*@Date :2017/8/29 18:13
// */
// @Configuration
// @MapperScan(basePackages = "com.zyd.multi.mapper.primary",
// sqlSessionTemplateRef = "primaryTestSqlSessionTemplate")
...
// primaryTestSqlSessionFactory(@Qualifier("primaryTestDataSource") DataSource
// primaryTestDataSource) throws Exception {
...
//// // 基于接口实现的多态
//// // 指向接口的引用（pageHelper）必须是实现了该接口的一个类的实例程序（implements
/// Interceptor），在运行时，根据对象引用的实际类型来执行对应的方法。
...
/// PathMatchingResourcePatternResolver().getResources("classpath:mybatis/primary/*.xml"));
...
/// primaryTestTransactionManager(@Qualifier("primaryTestDataSource") DataSource
/// primaryTestDataSource) {
...
/// testSqlSessionTemplate(@Qualifier("primaryTestSqlSessionFactory")
